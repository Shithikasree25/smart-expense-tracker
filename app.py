...
def logout():
    ...
    @app.route("/ai_tips")
def ai_tips():
    tip = "Try to keep your savings at least 20% of your monthly income."
...
def chat():
    ...
    if "total" in message:
        response = "You can check total expenses from the Total Expense section."
    elif "save" in message:
        response = "Saving regularly helps reduce financial stress."
    elif "rent" in message:
        response = "Rent is usually a fixed expense. Try to keep it under 30% of income."
    else:
        response = "I'm your expense assistant. Ask me about savings, expenses, or totals."
